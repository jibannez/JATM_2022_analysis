function [coeff,score,latent,tsquared,explained,mu] = run_pca_at_ISA(xp)    
% Copyright 2022 Jorge Ibáñez Gijón.
    ...
    disp('Variables in first component with coeff higher than 0.05')
    D(bdim1)'
    disp('Variables in second component with coeff higher than 0.1')
    D(bdim2)'
    % Add anotations for the variables that fit the criteria
